  ...
  return (
    ...
    <Box >
      ...
      <AccordionSummary sx={{fontWeight: 'Bold'}}>
        ...
        <AccordionDetails>
          A: Yes! After completing a quiz, you can view your results and see which questions you answered 
      ...
      <AccordionSummary sx={{fontWeight: 'Bold'}}>
        ...
        <AccordionDetails>
        A: PulseCheck tracks attendance based on your participation in live polls and quizzes during lectures. 
        </AccordionDetails>
      </Accordion>
      ...
      <AccordionSummary sx={{fontWeight: 'Bold'}}>
        ...
        <AccordionDetails>
        A: Absolutely! PulseCheck is fully responsive and works seamlessly on mobile devices. 
        </AccordionDetails>
      </Accordion>
    </React.Fragment>
  )
